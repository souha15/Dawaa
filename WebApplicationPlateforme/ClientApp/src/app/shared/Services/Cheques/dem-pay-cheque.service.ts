...
export class DemPayChequeService {
  ...
  SearchByPrix(prix) {
    return this.http.get<DemPayCheque[]>(this.rootURL + '/DemandePayCheques/SearchByPrix/' + prix);
  }
  SearchByNumDem(NumDem) {
    return this.http.get<DemPayCheque[]>(this.rootURL + '/DemandePayCheques/SearchByNumDem/' + NumDem);
  }
  SearchByPrixNumDem(NumDem, prix) {
    return this.http.get<DemPayCheque[]>(this.rootURL + '/DemandePayCheques/SearchByPrixNumDem/' + NumDem + '/' + prix);
  }
  GetUserPayChequeDemands(IdUser, nomDirecteur) {
    return this.http.get<DemPayCheque[]>(this.rootURL + '/DemandePayCheques/GetUserPayChequeDemands/' + IdUser + '/' +nomDirecteur );
  }
}
