...
@Component({
  selector: 'app-print-montage',
  templateUrl: './print-montage.component.html',
  styleUrls: ['./print-montage.component.css']
})
export class PrintMontageComponent implements OnInit {
  private routeSub: Subscription;
  @ViewChild('htmlData') htmlData: ElementRef;
  constructor(private mediaService: MontageService ,
