...
@Component({
  selector: 'app-print-rendonnee',
  templateUrl: './print-rendonnee.component.html',
  styleUrls: ['./print-rendonnee.component.css']
})
export class PrintRendonneeComponent implements OnInit {

  private routeSub: Subscription;
  @ViewChild('htmlData') htmlData: ElementRef;
  constructor(private mediaService: RendoneeService,
