...
@Component({
  selector: 'app-rapport-occasion-soiree',
  templateUrl: './rapport-occasion-soiree.component.html',
  styleUrls: ['./rapport-occasion-soiree.component.css']
})
export class RapportOccasionSoireeComponent implements OnInit {
