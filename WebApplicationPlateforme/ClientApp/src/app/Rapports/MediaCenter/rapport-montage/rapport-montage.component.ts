...
@Component({
  selector: 'app-rapport-montage',
  templateUrl: './rapport-montage.component.html',
  styleUrls: ['./rapport-montage.component.css']
})
export class RapportMontageComponent implements OnInit {
