...
@Component({
  selector: 'app-rapport-rendonne',
  templateUrl: './rapport-rendonne.component.html',
  styleUrls: ['./rapport-rendonne.component.css']
})
export class RapportRendonneComponent implements OnInit {
