...
@NgModule({
  ...
  { path: 'employee-update', component: EmployeeUpdateComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR'] } },
    ...
    //Evenement
      ...
      { path: 'formation-add', component: FormationAddComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE','FORMATIONPRIV'] } },

      { path: 'formation-list', component: FormationListComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE','FORMATIONPRIV'] }},

      { path: 'formation-show', component: FormationShowComponent, canActivate: [AuthGuard] },

      { path: 'specialite', component: SpecialiteComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE','FORMATIONPRIV'] } },
...
/** Events Report **/
    ...
    /**** Historique *****/
      ...
      { path: 'histo-menus', component: HistoMenusComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR']} },
